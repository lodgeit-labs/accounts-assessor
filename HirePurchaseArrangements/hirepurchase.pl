...
record_count_of_hp_arr(Arrangement, Record_Count) :-
	findall(Record_Number, (record_of_hp_arr(Arrangement, Record), hp_rec_number(Record, Record_Number)),
		Record_Numbers),
	max_list(Record_Numbers, Record_Count).
...
% record_of(hp_arrangement(0, 5953.2, 13, 1, 200.47, 1), Record).
