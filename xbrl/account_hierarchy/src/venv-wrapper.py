...
def main():
	lodgeit_root = "/home/sfi/t-rex/lodgeit2/lodgeit"
	script_root = lodgeit_root + "/xbrl/account_hierarchy"
	...
	full_command = "pwd; echo ""; source {0} ; {1} ; deactivate".format(activate_path, python_command)
