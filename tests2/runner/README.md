```
(venv) [10:20:21] koom@dev3 /home/koom/repos/lodgeit-labs/accounts-assessor/0/accounts-assessor/tests2/runner
rm -rf /tmp/luigid; ./luigi_scheduler_server.sh
```

```
(venv) [10:20:23] koom@dev3 /home/koom/repos/lodgeit-labs/accounts-assessor/0/accounts-assessor/tests2/runner
