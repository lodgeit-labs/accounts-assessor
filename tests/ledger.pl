...
findall(Trial_Balance,
	...
	[[entry(asset,t_term(140,0),
			[entry(bank,t_term(40,0),[]),
			entry(inventory,t_term(0,0),[]),
			entry(accounts_receivable,t_term(100,0),[]),
			entry(motor_vehicles,t_term(0,0),[])]),
		entry(liability,t_term(0,0),
			[entry(accounts_payable,t_term(0,0),[]),
			entry(super_payable,t_term(0,0),[]),
			entry(paygw_tax,t_term(0,0),[]),
			entry(wages_payable,t_term(0,0),[]),
			entry(hirepurchase_truck,t_term(0,0),[])]),
		entry(retained_earnings,t_term(0,50),[]),
		entry(equity,t_term(0,100),
			[entry(share_capital,t_term(0,100),[])]),
		entry(revenue,t_term(0,0),
			[entry(sales,t_term(0,0),[])]),
		entry(expense,t_term(10,0),
			[entry(cost_of_goods_sold,t_term(0,0),[]),
			entry(stationary,t_term(10,0),[]),
			entry(wages,t_term(0,0),[]),
			entry(super_expense,t_term(0,0),[]),
			entry(hirepurchase_interest,t_term(0,0),[])])]]).
...
findall(Balance_Sheet,
	...
	[[entry(asset,t_term(140,0),
		...
		entry(liability,t_term(0,0),
			...
			entry(wages_payable,t_term(0,0),[]),
			entry(hirepurchase_truck,t_term(0,0),[])]),
		entry(earnings,t_term(0,40),
			[entry(retained_earnings,t_term(0,50),[]),
			entry(current_earnings,t_term(10,0),[])]),
		entry(equity,t_term(0,100),
			[entry(share_capital,t_term(0,100),[])])]]).
...
findall(Movement,
	...
	[[entry(asset,t_term(2776,0),
			[entry(bank,t_term(0,299),[]),
			entry(inventory,t_term(75,0),[]),
			entry(accounts_receivable,t_term(0,0),[]),
			entry(motor_vehicles,t_term(3000,0),[])]),
		entry(liability,t_term(0.0,2982.42),
			[entry(accounts_payable,t_term(0,125),[]),
			entry(super_payable,t_term(0,0),[]),
			entry(paygw_tax,t_term(0,0),[]),
			entry(wages_payable,t_term(0,0),[]),
			entry(hirepurchase_truck,t_term(0.0,2857.42),[])]),
		entry(equity,t_term(0,0),
			[entry(share_capital,t_term(0,0),[])]),
		entry(revenue,t_term(0,100),
			[entry(sales,t_term(0,100),[])]),
		entry(expense,t_term(306.42,0),
			[entry(cost_of_goods_sold,t_term(50,0),[]),
			entry(stationary,t_term(0,0),[]),
			entry(wages,t_term(200,0),[]),
			entry(super_expense,t_term(19,0),[]),
			entry(hirepurchase_interest,t_term(37.42,0),[])])]]).
