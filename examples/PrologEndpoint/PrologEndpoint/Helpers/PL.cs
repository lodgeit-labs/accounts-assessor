...
namespace PrologEndpoint.Helpers
{
    ...
    struct PL_thread_attr_t
    {
        ...
        public IntPtr alias;            /* alias name */
        public IntPtr cancel;		/* cancel function */
        public long flags;           /* PL_THREAD_* flags */
    ...
    class PL
    {
        ...
        public static IntPtr ATOM_nil() { return Marshal.ReadIntPtr(_PL_atoms(), 0 * IntPtr.Size); /* `[]` */ }
        public static IntPtr ATOM_dot() { return Marshal.ReadIntPtr(_PL_atoms(), 1 * IntPtr.Size); /* `.` */ }
        ...
        [DllImport(dllName)] public extern static IntPtr PL_predicate(IntPtr name, int arity, string module);
        ...
        /* Constants */
        [DllImport(dllName)] public extern static IntPtr PL_new_atom(IntPtr s);
        ...
        [DllImport(dllName)] public extern static IntPtr PL_atom_chars(IntPtr a);
        [DllImport(dllName)] public extern static IntPtr PL_atom_nchars(IntPtr a, out UIntPtr len);
        [DllImport(dllName)] public extern static IntPtr PL_atom_wchars(IntPtr a, out UIntPtr len);
        ...
        [DllImport(dllName)] public extern static IntPtr PL_quote(int chr, string data);
        ...
        [DllImport(dllName)] public extern static IntPtr PL_cwd(StringBuilder buf, UIntPtr buflen);
        ...
        [DllImport(dllName)] public extern static IntPtr PL_record_external(IntPtr t, out UIntPtr size);
        ...
        [DllImport(dllName)] public extern static int PL_initialise(int argc, IntPtr argv);
        ...
        public readonly IntPtr PL_ENGINE_MAIN = new IntPtr(0x1);
        public readonly IntPtr PL_ENGINE_CURRENT = new IntPtr(0x2);
        ...
        [DllImport(dllName)] public extern static IntPtr PL_create_engine(ref PL_thread_attr_t attributes);
        [DllImport(dllName)] public extern static int PL_set_engine(IntPtr engine, out IntPtr old);
        [DllImport(dllName)] public extern static int PL_destroy_engine(IntPtr engine);
    }
}