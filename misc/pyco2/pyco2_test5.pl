...
p([	last(List, Last_item, List_without_last_item)
...
p([	'"last" test 1'(List0, Last_item, Rest)
		,fr(List0, 0, List1)
		,fr(List1, 1, List2)
		,fr(List2, 2, List3)
		,fr(List3, 3, List4)
...
p([	'"last" test 2'(List0, Last_item, Rest)
		,List0 = nil
		,last(List0, Last_item, Rest)
]).

p([	'"last" test 3'(List0, Last_item, Rest)
		,fr(List0, 0, List1)
		,fr(List1, 1, List2)
		,fr(List2, 2, List3)
		,fr(List3, 3, List4)
...
p([	'slice out item by index'(List, Idx, Item, Rest)
		,Idx = 0
		,fr(List, Item, Rest)
	,bc
]).

p([	'slice out item by index'(List, Idx, Item_at_idx, List_without_item)
		,Idx #> 0
		,New_idx #= Idx - 1
...
p([	vec_inverse(V, Vi)
		,fr(V, VH, VT)
		,fr(Vi, ViH, ViT)
		,coord_inverse(VH,ViH)
		,vec_inverse(VT, ViT)
]).

p([	vec_inverse(nil, nil)
	,bc
]).
