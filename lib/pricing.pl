...
test0 :-
	...
	Cost_Of_Goods = [('TLS', 2, value('AUD',10), 0)].
...
test3 :-
	...
	%print_term(Cost_Of_Goods, []).
	Cost_Of_Goods = [('TLS', 5, value('AUD',25), 1), ('TLS', 1, value('USD',5), 2)].
