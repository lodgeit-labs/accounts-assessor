...
transactions_by_account(Static_Data, Transactions_By_Account) :-
	...
	transactions_before_day_on_account_and_subaccounts(Dict, $>account_by_role(rl('ComprehensiveIncome')), Start_Date, Historical_Earnings_Transactions),
	...
	transactions_in_period_on_account_and_subaccounts(Dict, $>account_by_role(rl('ComprehensiveIncome')), Start_Date, End_Date, Current_Earnings_Transactions),
