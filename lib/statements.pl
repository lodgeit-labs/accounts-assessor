		...
		(
			...
			->
				(
					...
					make_currency_movement_transactions(Exchange_Rates, Accounts, UnX_Account, Report_Currency, Transaction_Day, Vector_Ours, [Description, ' - currency movement adjustment'], Ts3)
				)
			;
