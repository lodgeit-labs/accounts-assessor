...
depreciation_between_start_date_and_other_date(
	...
	(
		Days_difference < Days_held
			...
			depreciationAsset(Asset_id,T1,T2,Initial_value,_,Method,Depreciation_year,_,While_in_pool,What_pool,0,Depreciation_value),
...
depreciation_pool(Pool,From_date,To_date,Begin_value,Method,Total_depreciation):-
	...
	findall(Depreciation_value,depreciation_between_start_date_and_other_date(Begin_value,Method,From_date,To_date,_,_,1,true,Pool,0,Depreciation_value),
...
depreciation_between_two_dates(Asset_id, From_date, To_date, Method, Rates, Depreciation_value):-
	day_diff(From_date, To_date, Days_difference),
	check_day_difference_validity(Days_difference),
	written_down_value(Asset_id, To_date, Method, Rates, To_date_written_down_value),
	written_down_value(Asset_id, From_date, Method, Rates, From_date_written_down_value),
...
written_down_value(Asset_id, Written_down_date, Method, Rates, Written_down_value):-
